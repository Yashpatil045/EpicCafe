...
<div class="menu_align">
  ...
  <div class="menu-item">
    <center>
    <img src="img/cofee.jpg" alt="Beverage 1" class="item-image"></center>
    <div class="item-details">
  ...
  <div class="menu-item">
    <center>
    <img src="img/falooda.jpg" alt="Beverage 1" class="item-image"></center>
    <div class="item-details">
  ...
  <div class="menu-item">
    <center>
    <img src="img/mango_juice.jpg" alt="Beverage 1" class="item-image"></center>
    <div class="item-details">
  ...
  <div class="menu-item">
    <center>
    <img src="img/watermelon_juice.jpg" alt="Beverage 1" class="item-image"></center>
    <div class="item-details">
  ...
  <div class="menu-item">
    <center>
    <img src="img/pinapple_juice.jpg" alt="Beverage 1" class="item-image"></center>
    <div class="item-details">
  ...
  <div class="menu-item">
    <center>
    <img src="img/orange_juice.jpg" alt="Beverage 1" class="item-image"></center>
    <div class="item-details">
  ...
  <div class="menu-item">
    <center>
    <img src="img/chocolate.jpg" alt="Beverage 1" class="item-image"></center>
    <div class="item-details">
...
<style>
  ...
  header {
    ...
    background-color: #333;
    /* bacbackground-image: url(menu.jpg); */
  ...
  @media(max-width:599px){
    ...
    <script>
      //button var click kelyavar tyach name ani price save hoil ani order.html madhye transfer hoil
	function order(name, price) {
            sessionStorage.setItem('name', name);
            sessionStorage.setItem('price', price);
            window.location.href="http://localhost/Project/IP%20Project/IP%20Project/order.php";  //because of these we make file php  
              }
	</script>
