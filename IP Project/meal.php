...
<html lang="en">
  ...
  <body>
        ...
        <div class="food-details">
          ...
          <p>
            <b style="font-size: large"
              ><p>
                150rs /-
                <span style="font-size: smaller; font-weight: lighter"
                  >(for one plate)</span
                >
              </p></b
            >
      ...
      <div class="food-item">
        ...
        <div class="food-details">
          ...
          <p class="food-description">
            ...
            mix veggies, herbs & biryani spices.
          </p>
          <p>
            <b style="font-size: large"
              ><p>
    ...
    <script>
      ...
      window.location.href="http://localhost/Project/IP%20Project/IP%20Project/order.php";
      }
    </script>
  </body>
</html>
