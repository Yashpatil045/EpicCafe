...
$username = "if0_36244851";
$password = "EpicCafe45";
$database = "if0_36244851_epic";
...
$sql2 = "SELECT * FROM `transaction` ORDER BY Date DESC LIMIT 1"; // Corrected SQL query
...
// to fetch data id  from transaction over
